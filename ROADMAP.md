...
2. **Release 附件**：`v2.6.0` release 附带三平台二进制（`harness-evolution-windows.exe` / `harness-evolution-linux` / `harness-evolution-macos`）
...
| 里程碑 | 目标 | 状态 |
|--------|------|------|
| v2.6.0-alpha.1 | CI 构建矩阵 + 三平台二进制 | 待开始 |
| v2.6.0-beta.1 | 安装脚本 + dsh plugin 集成 | 待开始 |
| v2.6.0-rc.1 | L4 沙盒验证通过 | 待开始 |
| v2.6.0 | 正式发布 + L5 端到端测试 | 待开始 |
